...
class Level4 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level4Drinks: props.Level4Drinks,
      currentDrink: Object.keys(props.Level4Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level4Drinks;
      ...
      if (n != m) {
        ...
        if (this.state.counter == 3) {
          alert("GET READY FOR LEVEL 5")
          this.props.history.push("/Level5")
        }
        this.setState({
          currentDrink: Object.keys(this.props.Level4Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level4Drinks: state.drinks.Level4,
