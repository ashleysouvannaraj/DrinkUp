...
class Level3 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level3Drinks: props.Level3Drinks,
      currentDrink: Object.keys(props.Level3Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level3Drinks;
      let m = drinkObject[currentDrink].length;
      let n = mergedIngredients.length;
      console.log(drinkObject[currentDrink]);
      ...
      if (n != m) {
        ...
        if (this.state.counter == 3) {
          alert("GET READY FOR LEVEL 4");
          this.props.history.push("/Level4")
        }
        this.setState({
          currentDrink: Object.keys(this.props.Level3Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level3Drinks: state.drinks.Level3,
