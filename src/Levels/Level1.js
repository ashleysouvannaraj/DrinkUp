...
class Level1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level1Drinks: props.Level1Drinks,
      currentDrink: Object.keys(props.Level1Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level1Drinks;
      ...
      if (n != m) {
        ...
        this.setState({
          currentDrink: Object.keys(this.props.Level1Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level1Drinks: state.drinks.Level1,
