...
class Level9 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level9Drinks: props.Level9Drinks,
      currentDrink: Object.keys(props.Level9Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level9Drinks;
      ...
      if (n != m) {
        ...
        if (this.state.counter == 3) {
          alert("GET READY FOR LEVEL 10!!!")
          this.props.history.push("/Level10")
        }
        this.setState({
          currentDrink: Object.keys(this.props.Level9Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level9Drinks: state.drinks.Level9,
