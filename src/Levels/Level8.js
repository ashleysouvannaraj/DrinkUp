...
class Level8 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level8Drinks: props.Level8Drinks,
      currentDrink: Object.keys(props.Level8Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level8Drinks;
      ...
      if (n != m) {
        ...
        if (this.state.counter == 3) {
          alert("GET READY FOR LEVEL 9")
          this.props.history.push("/Level9")
        }
        this.setState({
          currentDrink: Object.keys(this.props.Level8Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level8Drinks: state.drinks.Level8,
