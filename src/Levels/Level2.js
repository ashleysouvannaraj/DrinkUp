...
class Level2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Level2Drinks: props.Level2Drinks,
      currentDrink: Object.keys(props.Level2Drinks)[0],
      selectedLiquor: [],
      selectedLiquer: [],
      selectedMixers: [],
      selectedGarnishes: [],
...
checkIngredients = (e) => {
  ...
  let mergedIngredients = liquors.concat(liquers, mixers);
      ...
      let drinkObject = this.state.Level2Drinks;
      ...
      if (n != m) {
        ...
        if (this.state.counter == 3) {
          alert("GET READY FOR LEVEL 3")
          this.props.history.push("/Level3")
        }
        this.setState({
          currentDrink: Object.keys(this.props.Level2Drinks)[this.state.counter2+1],
          selectedLiquor: [],
         selectedLiquer: [],
         selectedMixers: [],
...
selectMixers = (e) => {
  ...
  const mapStateToProps = (state) => ({
    ...
    Level2Drinks: state.drinks.Level2,
